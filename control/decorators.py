...
ROLES_CONTROLES   = ('admin', 'gerente', 'supervisor', 'encargado',)
ROLES_CONFIG_VER  = ('admin', 'tecnico', 'gerente', 'supervisor',)
...
ROLES_CUADRATURA_DIARIA  = ('admin', 'gerente', 'supervisor', 'encargado')
